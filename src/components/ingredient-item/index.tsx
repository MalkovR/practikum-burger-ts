...
const IngredientItem: React.FC<IBurgerIngredientInfo>  = ({burgerIngredient}) => {
  ...
  return (
    <div className={style.ingredient_item_container}>
      ...
      <span className={`${style.price} mt-1 mb-1`}>
        <p className="text text_type_digits-medium mr-2">{burgerIngredient.price}</p>
        <CurrencyIcon type="primary"/>
      </span>
      <span className={`${style.description} text text_type_main-small`}>{burgerIngredient.name}</span>
